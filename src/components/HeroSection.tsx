...
const HeroSection: React.FC = () => {
  return (
    <div className="relative bg-gray-900 text-[#f9f1d2]">
      ...
      <div className="relative container mx-auto px-4 py-24 md:py-32 flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-[#f9f1d2]">
          Gesunde Mahlzeiten direkt zu dir nach Hause
        </h1>
        
        <p className="text-xl md:text-2xl mb-8 max-w-3xl text-[#f9f1d2]">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Button 
            asChild
            size="lg" 
            className="bg-brand-green hover:bg-brand-darkgreen text-[#f9f1d2] px-8 py-6 text-lg"
          >
          ...
          <Button 
            ...
            variant="outline" 
            size="lg" 
            className="bg-transparent border-[#f9f1d2] text-[#f9f1d2] hover:bg-[#f9f1d2] hover:text-gray-900 px-8 py-6 text-lg"
          >
