    ...
    <section className="py-16 bg-brand-gray">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Testimonial 
            quote="Die Mahlzeiten sind nicht nur super lecker, sondern helfen mir auch, meine Fitnessziele zu erreichen. Einfach perfekt für meinen stressigen Alltag!"
            author="Laura K."
          ...
          <Testimonial 
            quote="Endlich eine Meal-Prep-Option, die wirklich schmeckt! Die Vielfalt ist großartig und ich freue mich jeden Tag auf meine Mahlzeit."
            author="Sophie W."
