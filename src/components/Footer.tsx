        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/how-it-works" className="text-gray-300 hover:text-white">Wie es funktioniert</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-white">Kontakt</Link>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Datenschutz</a>
              </li>
              <li>
